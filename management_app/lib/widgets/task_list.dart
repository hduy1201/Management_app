...
import 'package:management_app/services/theme_services.dart';
...
import 'package:management_app/widgets/task_tile.dart';
    ...
    return Row(
      ...
      children: [
        ...
        MyButton(
            label: '+ Add Task',
            onTap: () {
              Get.to(() => AddTaskDialogPage(), transition: Transition.native);
            })
      ],
    );
  }
